...
const AnecdoteDetail = ({ anecdote, vote }) => {
  return (
    <div>
      ...
      <p onClick={() => vote(anecdote.id)}>has {anecdote.votes} votes</p>
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path='/anecdote/:id' element={<AnecdoteDetail anecdote={anecdote} vote={vote} />} />
